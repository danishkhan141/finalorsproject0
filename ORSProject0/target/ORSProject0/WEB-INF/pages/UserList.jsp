							...
							<div class="form-inline">
								...
								<div class="form-group  text-center">
									<label class="control-label" for="firstName"> <s:message
										...
										size=15 placeholder="${firstName}" value="${param.firstName }">
								</div>
								...
								<div class="form-group  text-center">
									<label class="control-label" for="login"> <s:message
										...
										placeholder="${login}" value="${param.login }">
								</div>
											...
											<c:forEach items="${list}" var="user" varStatus="ct">
												<tr>
													...
													<c:when  test="${user.roleId==1 }">
														<td align="center"><input type="checkbox" name="ids" disabled="disabled"
															value=""></td>
													</c:when>
													<c:otherwise><td align="center"><input type="checkbox" name="ids" 
															value="${user.id}"></td></c:otherwise>
													</c:choose>
													...
													<c:choose>
													<c:when test="${user.roleId==1 }">
														<td style="size: 20%; text-align: center;">   <span
